...
const getVisibleCards = (cards: Card[] , pageIndex: number): Card[] => {
    return cards.slice (pageIndex * ITEMS_PER_PAGE , (pageIndex + 1) * ITEMS_PER_PAGE);
};
...
export default function PhotosCards() {
    ...
    return (
        <div className="p-8 text-gray-900 w-full bg-cover bg-center mt-36"
            ...
            <div className="flex justify-center items-center mb-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    { visibleCards.length > 0 ? (
                        ...
                        <div className="col-span-3 text-center text-gray-500">No cards available.</div>
                    ) }
                </div>
            </div>
